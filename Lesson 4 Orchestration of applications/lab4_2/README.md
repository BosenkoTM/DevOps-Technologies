## Практическая работа 4.2. Сервис Kubernetes
### Задача
Развернуть свой собственный сервис в `Kubernetes`, по аналогии с `Практическая работа 4.1.`

**Можно использовать Minikube из `Практическая работа 4.1.` Нужно развернуть сервис в связке из минимум 2 контейнеров + 1 init, по аналогии с `Практическая работа 3.2.`.
Требования:**
